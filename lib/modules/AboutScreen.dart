      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height:10),
            Text("Excellence in fulfilling all of our customers' banking needs, maximizing the value of shareholders, inspiring employees' loyalty and  playing a leading role in the prosperity and development of India.",style:TextStyle(fontWeight: FontWeight.bold,color: primary,fontSize: 17)),
            SizedBox(height:20),
